  ...
  <div class="panel mb" id="c-imc">
    ...
    <div class="panel-body" style="display:grid;grid-template-columns:1fr 1fr;gap:24px">
      <div>
        ...
        <div class="field"><label class="field-label">Talla (m)</label><input class="input" type="number" step="0.01" id="imc-h" value="1.65" oninput="recalcIMC()"></div>
      </div>
    ...
    <div class="panel-body" style="display:grid;grid-template-columns:1fr 1fr;gap:24px">
      <div>
        <div class="field-row">
          ...
          <div class="field"><label class="field-label">Talla (m)</label><input class="input" type="number" step="0.01" id="kc-h" value="1.65" oninput="recalcKcal()"></div>
        </div>
        <div class="field-row">
    ...
    <div class="panel" id="c-gest">
      ...
      <div class="panel-body" style="display:grid;grid-template-columns:1fr 1fr;gap:18px;align-items:center">
        <div>
          ...
          <div class="field"><label class="field-label">Talla (m)</label><input class="input" type="number" step="0.01" id="gst-h" value="1.65" oninput="recalcGest()"></div>
        </div>
