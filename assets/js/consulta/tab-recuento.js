      ...
      <div class="panel mb-sm">
        <div class="panel-head">
          ...
          <div style="display:flex;gap:8px">
            ...
            <button class="btn btn-sage btn-xs" onclick="toast('Nuevo recuento iniciado ✓')">+ Nuevo</button>
          </div>
        </div>
        <div class="panel-body">
          ${isEmpty ? `<div style="text-align:center;padding:40px">
            ...
            <button class="btn btn-sage btn-sm" style="margin-top:14px">+ Iniciar recuento</button>
    ...
    <div>
      ...
      <div class="panel">
        ...
        <div class="panel-body">
          ...
          <button class="btn btn-sage btn-xs" style="margin-top:8px" onclick="toast('Nota guardada ✓')">Guardar</button>
        </div>
      </div>
    </div>
  </div>`;
