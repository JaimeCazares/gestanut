...
function renderConsulta() {
  ...
  c.innerHTML = `<div class="view active">
        ...
        <div style="display:flex;align-items:flex-start;gap:18px">
          ...
          <div>
            ...
            <div style="display:flex;gap:8px;flex-wrap:wrap">
              ...
              <button class="btn btn-sm" onclick="openModal('receipt-modal')" style="background:rgba(255,255,255,.12);border:1px solid rgba(255,255,255,.2);color:var(--cream)">🧾 Recibo</button>
    ...
    <!-- Tabs -->
    <div class="ctabs">${tabs.map(t => `<button class="ctab${consultaTab === t.k ? ' active' : ''}" onclick="setCTab('${t.k}')">${t.l}</button>`).join('')}</div>
