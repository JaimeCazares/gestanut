...
function tabMediciones(p) {
  return `<div class="g2">
    <div class="panel"><div class="panel-head"><div class="panel-title"><span class="pt-icon">📐</span>Medidas actuales</div><button class="btn btn-sage btn-xs">+ Nueva</button></div>
