  ...
  return `<div>
    ...
    <div class="panel mb-sm">
      <div class="panel-head"><div class="panel-title"><span class="pt-icon">🔬</span>Resultados de laboratorio</div>
        <button class="btn btn-sage btn-xs" onclick="toast('Agregando resultados ✓')">+ Agregar</button>
      </div>
      ${p.laboratorio.length ? `<div style="overflow:hidden">
        ...
        <button class="btn btn-sage btn-sm" style="margin-top:14px" onclick="toast('Agregando laboratorio ✓')">+ Registrar resultados</button>
      </div>`}
    </div>
